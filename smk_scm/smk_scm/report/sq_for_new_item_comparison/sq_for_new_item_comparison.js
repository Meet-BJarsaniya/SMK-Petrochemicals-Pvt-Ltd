...
frappe.query_reports["SQ for New Item Comparison"] = {
	"filters": [
		{
			fieldtype: "Link",
			label: __("Company"),
		...
		},
		{
			...
			default: "",
			get_data: function (txt) {
				return frappe.db.get_link_options("Supplier Quotation for New Item", txt, { docstatus: ["<", 2] });
			},
		},
		{
			fieldtype: "Link",
	...
	onload: (report) => {
		...
		report.page.add_inner_button(
			...
			() => {
				let reporter = frappe.query_reports["SQ for New Item Comparison"];
